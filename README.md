...
>C++/BP 경계 설정 기준 정립 및 품질 코드 작성, 유지보수 및 확장성 확보
...
| **주요 시스템**                | • Gameplay Ability System 전 영역<br>• 스탯/어트리뷰트/레벨업/경험치<br>• 능력·스킬·쿨다운·자원 관리<br>• Top-down 전투·AI(BT + EQS)<br>• 멀티플레이어 대응 구조 |
